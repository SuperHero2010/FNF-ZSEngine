...
class ScriptDebuggersSubState extends BaseOptionsMenu
{
    public function new()
    {
        ...
        var option:Option = new Option('Haxe Debugger',
            'If checked, enables the Haxe Debugger, allowing you to debug the Haxe scripts in Psych Engine',
            'haxeDebugger',
            BOOL);
        addOption(option);

        var option:Option = new Option('ZS Debugger',
            'If checked, enables the ZS Debugger, allowing you to debug the ZS scripts in Psych Engine',
            'zsDebugger',
            BOOL);
        addOption(option);
