    ...
    public static function validate(source:String):Array<String> {
        ...
        for (i in 0...lines.length) {
            ...
            if (colonPos > 0) {
                ...
                var zsKeywords = ["change", "read", "print", "print(debug)", "register", "apply", "import", "local", "global", "add", "create", "start", "close", "exit", "restart", "load", "trigger", "call", "instance", "remove", "scale", "update", "play", "cancel", "stop", "pause", "resume", "cancel", "center", "shake", "fade", "flash", "mouse", "key", "keyboard", "any", "gamepad", "tween", "run", "flush", "erase", "precache"];
